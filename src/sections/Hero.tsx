        ...
        <div className="max-w-lg mx-auto mt-8">
          <h1 className="font-serif text-3xl md:text-5xl text-center mt-8 tracking-wide ">
            <span className="bg-gradient-to-r from-purple-300 via-indigo-300 to-blue-400 bg-clip-text text-transparent animate-gradient-shift bg-300%">
              Making Every Click Count with Intuitive Design
            </span>
          </h1>
          ...
          <p className="mt-6 text-center text-white/70 relative">
            <span className="relative" >
              ...
              Whether your starting from scratch or leveling up an existing project.
              I am here to help bring your vision to life. Let’s create something exceptional—ready to chat about your next big idea?
            </span>
          </p>
        </div>
